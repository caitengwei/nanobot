...
class TranscriptionConfig(Base):
    ...
    provider: str = "groq"  # "groq", "openai", or "qwen3-asr"
    api_key: str = ""  # provider-specific key; falls back to providers.* keys
    api_base: str = ""
...
class ChannelsConfig(Base):
    ...
    transcription_provider: str = (
        "groq"  # Voice transcription backend: "groq", "openai", or "qwen3-asr"
    )
